...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '小吴乐意', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '人类', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.xiaowuleyi.com', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || '小吴, 博客, 比特币, 生活, 思考', // 网站关键词 英文逗号隔开
